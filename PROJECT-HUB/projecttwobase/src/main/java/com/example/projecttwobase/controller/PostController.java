...
public class PostController {
    ...
    //ALLOWS A USER TO CREATE A POST / REFER TO POST SERVICE
    ...
    //ALLOWS A USER TO GET A LIST OF ALL POSTS / REFER TO POST SERVICE
    @GetMapping("/posts/list")
    public Iterable<Post> listPosts(){
        return postService.listAllPosts();
    }

    //ALLOWS A USER TO GET A POST BY POST ID / REFER TO POST SERVICE
    @GetMapping("/post/{postId}")
    public Post postsById(@Valid @PathVariable Long postId) {
        return postService.getPostByPostId(postId);
    }

    //ALLOWS A USER TO DELETE A POST BY POST ID / REFER TO POST SERVICE
    ...
    //ALLOWS A USER TO GET ALL POSTS BY A USER ID / REFER TO POST SERVICE
